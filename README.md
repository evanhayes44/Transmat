...
**[Live → transmat-emh.vercel.app](https://transmat-emh.vercel.app)**

## Screenshots

|               Login               |                                    Item Detail                                     |
| :-------------------------------: | :--------------------------------------------------------------------------------: |
| ![Login screen](public/login.png) | ![Item detail modal with stats, perks, and transfer controls](public/transfer.png) |

![Inventory view showing three characters with equipped gear and inventory queues](public/inventory.png)
_Three-character inventory view with emblem backgrounds, tier pips, and masterwork glows_

![Vault view with search, sort, element, champion, exotic, and weapon-type filters active](public/vault.png)
_Vault with full filter and sort controls_
