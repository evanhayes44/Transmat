...
export async function getManifest() {
    const manifestMeta: ManifestResponse = await bungieGet(`/Destiny2/Manifest/`)
    ...
    const itemPath = manifestMeta.Response.jsonWorldComponentContentPaths["en"]["DestinyInventoryItemDefinition"]
    const downloadUrl = "https://www.bungie.net" + itemPath

    const titlePath = manifestMeta.Response.jsonWorldComponentContentPaths["en"]["DestinyRecordDefinition"]
