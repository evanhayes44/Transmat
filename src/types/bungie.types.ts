...
export interface DestinyProfileInventoryResponse {
  Response: {
    ...
    itemComponents: {
      ...
      stats: {
        data: Record<string, { stats: Record<string, DestinyItemStatBlock> }>;
      };
...
export interface InventoryState {
  ...
  itemStats: Record<
    string,
    { stats: Record<string, DestinyItemStatBlock> }
  > | null;
  itemSockets: Record<string, { sockets: DestinyItemSocketState[] }> | null;
  itemPlugObjectives: Record<
    string,
    { objectivesPerPlug: Record<string, DestinyObjectiveProgress[]> }
  > | null;
  isLoading: boolean;
